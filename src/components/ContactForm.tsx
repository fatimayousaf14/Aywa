  ...
  if (isSuccess) {
    return (
      <div
        ...
        style={{
          background:
            "linear-gradient(135deg, rgba(234, 228, 219, 0.85) 0%, rgba(214, 191, 167, 0.75) 100%)",
          backdropFilter: "blur(12px)",
          boxShadow:
            "0 8px 32px rgba(42, 36, 30, 0.08), 0 2px 8px rgba(42, 36, 30, 0.04)",
        }}
      >
        <div className="mb-6">
          <svg
          ...
          onMouseEnter={(e) => {
            if (!isSubmitting) {
              ...
              e.currentTarget.style.boxShadow =
                "0 6px 24px rgba(154, 161, 124, 0.32)";
            }
          }}
          onMouseLeave={(e) => {
            if (!isSubmitting) {
              ...
              e.currentTarget.style.boxShadow =
                "0 4px 16px rgba(154, 161, 124, 0.24)";
            }
          }}
        >
